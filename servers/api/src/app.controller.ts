...
import type { ChatMessage } from '../typings/types';

// import { START_SIGN, END_SIGN} from 'keysama-constant';
import { AppService } from './app.service';

const messageBusy =
    '非常抱歉，由于网络原因，这条对话未能完成，这条对话我们可以当作无事发生，您可以继续对话';
const messagePendding = '我正在努力回复您，请不要着急喵～';
...
function mock(request, opts): Promise<ChatMessage> {
    ...
    const text =
        '菲利斯喵喵，秋叶原最棒的女仆咖啡店哦～服务周到，可爱程度满分，超能力模式开启！就是这么一只超级可爱的猫娘，我是菲利斯喵喵！';
...
export class AppController {
    ...
    static async index(@Body() body: ChatRequest, @Res() res: Response): Promise<any> {
